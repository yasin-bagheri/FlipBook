  ...
  H.prototype = {
    ...
    foldPage: function (a, b, c, d, e) {
      ...
      this._currentFlip.page == a &&
        ...
        this._currentFlip.page.data("holdedAt", {
          x: b,
          y: c,
        }),
    ...
    releasePage: function (a, b, c, d) {
      ...
      if (b && g)
        ...
        this.foldShadow.removeClass("wowbook-shadow-fold-flipped").css({
          transform: "",
          left: "",
        }),
        this.foldGradientElem
    ...
    setFindBarEventHandlers: function (a) {
      ...
      a.find(".wowbook-find-previous").on(
        "click",
        {
          previous: !0,
        },
